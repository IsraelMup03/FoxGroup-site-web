...
import { ArrowUpRight, Coins, LayoutGrid, LogOut, Package, ShoppingCart } from 'lucide-react';
import Logo from '../components/Logo';
import { useAuth } from '../context/AuthContext';

const LIENS = [
  { vers: '/admin', libelle: 'Tableau de bord', icone: LayoutGrid, fin: true },
  { vers: '/admin/commandes', libelle: 'Commandes', icone: ShoppingCart },
  { vers: '/admin/produits', libelle: 'Produits', icone: Package },
  { vers: '/admin/taux', libelle: 'Taux de change', icone: Coins },
];
